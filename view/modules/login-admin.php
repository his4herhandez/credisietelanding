<section class="bg-blanco/20">
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen lg:py-0">
        <div class="flex justify-center items-center flex-row text-azul">
            <h1 class="text-uppercase text-5xl translate-x-1 font-bold">credi</h1><h1 class="text-7xl font-bold">7</h1>
        </div>
        <div class="w-full rounded-xl shadow dark:border md:mt-0 sm:max-w-md xl:p-0 bg-negro border-gray-700 border-2">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" method="post">
                    ...
                    <button type="submit" class="w-full text-white bg-azul/90 hover:bg-azul focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center">Ingresar</button>
